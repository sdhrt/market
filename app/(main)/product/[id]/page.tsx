...
async function page({ params }: { params: { id: number } }) {
  ...
  return (
    <div className="md:m-20 lg:m-40">
      <div className="flex flex-col md:flex-row items-center gap-5 md:gap-0 md:justify-evenly">
        ...
        <div className="flex flex-col justify-between">
          <div className="flex flex-col">
            ...
            <span className="text-sm text-muted-foreground line-clamp-3 overflow-y-scroll">
              {product?.description}
            </span>
          </div>
